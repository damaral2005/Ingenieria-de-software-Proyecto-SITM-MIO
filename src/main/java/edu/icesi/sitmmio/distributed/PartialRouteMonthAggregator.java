...
public final class PartialRouteMonthAggregator {
    public List<PartialRouteMonthAggregate> aggregate(List<SpeedSegment> segments) {
    ...
    private static final class Accumulator {
        ...
        private PartialRouteMonthAggregate toResult(RouteMonthKey key) {
            return new PartialRouteMonthAggregate(
                    key.routeId,
                    key.month,
                    totalDistanceKm,
                    totalTimeHours,
                    totalSegmentSpeedKmh,
                    validSegments,
                    observedBusIds.size());
        }
    }
